    ...
    const App = {
            ...
            if (App.htmlElements.session) {
                ...
                App.htmlElements.documentDOM.addEventListener('input', (e) => {
                    ...
                    if(e.target.getAttribute('name')=="payment") {
                        ...
                        console.log(sessionStorage.getItem("metodoPago"));
        ...
        handlers: {
            ...
            renderShipping: () => {
                ...
                console.log(sessionStorage.getItem("metodoEnvio"));
                console.log(sessionStorage.getItem("shippingPrice"));
            },
            renderSubtotal: () => {
            ...
            renderItbms: () => {
                ...
                console.log(sessionStorage.getItem("itbms"));
            },
            renderTotal: () => {
